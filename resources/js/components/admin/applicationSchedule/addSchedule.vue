                                        ...
                                        <form>
                                            <div class="com-bg">
                                                ...
                                                <div style="background-color: #fff;padding: 10px;border-radius: 5px;">
                                                    <div class="form-row">
                                                        <div class="col-xl-3"><label>Session</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="text" disabled="" readonly="" value="2021 - 2022"></div>
                                                        </div>
                                                        <div class="col-xl-3"><label>Start Date</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="date"></div>
                                                        </div>
                                                        <div class="col-xl-3"><label>Last Date</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="date"></div>
                                                        </div>
                                                     <div class="col-xl-3"><label>Scholarship Type</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" value="Nursing" type="text" disabled></div>
                                                        </div>
                                                        <div class="col-xl-4"><label>Application No. Prefix</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="text"></div>
                                                        </div>
                                                        <div class="col-xl-4"><label>Contact person's Email ID</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="email"></div>
                                                        </div>
                                                        <div class="col-xl-4"><label>Contact person's Mobile No.</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="text"></div>
                                                        </div>
                                                    </div>
                                                </div>
