                    ...
                    <div class="container-fluid"><a class="navbar-brand text-uppercase text-white" href="#"><strong>I-MIS APPlication</strong></a><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="navbar-nav flex-nowrap ml-auto">
                                ...
                                <div class="nav-item dropdown no-arrow dr-not"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><i class="fas fa-envelope fa-fw"></i><span class="badge badge-danger badge-counter">7</span></a>
                                    <div class="dropdown-menu dropdown-list dropdown-menu-right animated--grow-in">
                                        <h6 class="dropdown-header">messages center</h6><a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle" :src="'public/assets/img/avatar_2x.png'">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow dr-not"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><img class="border rounded-circle img-profile" :src="'public/assets/img/avatar_2x.png'"><span class="d-none d-lg-inline ml-2 text-white-600 small"><strong>Administrator</strong></span></a>
                        ...
                        <div class="col-md-12 col-xl-12 offset-xl-0 px-0">
                            <div class="row my-2">
                                <div class="col-xl-12 offset-xl-0">
                                    <h4 class="mb-0 p-head">Manage Domains</h4>
                                </div>
                            </div>
                            <div class="com-bg">
                                <div>
                                            ...
                                            <div class="col-xl-12" style="padding: 0px 5px;">
                                                <form>
                                                    <div class="form-group mb-0">
                                                        <div class="form-row">
                                                            <div class="col-xl-3 offset-xl-7 align-self-center and-col">
                                                                <form>
                                                                    <div class="form-group mb-0">
                                                                        <div class="form-row">
                                                                            <div class="col-sm-4 col-xl-7 offset-xl-0 align-self-center">
                                                                                <p class="text-right mb-0 mt-0 font-sm"><strong>Add New Domain?&nbsp;</strong></p>
                                                                            </div>
                                                                            <div class="col-sm-4 col-xl-4 offset-xl-0 text-right align-self-center">
                                                                                <p class="text-left mb-0 font-sm"><strong>&nbsp;</strong><router-link to="/admin/add-domains"><strong>Click here</strong></router-link></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                            <div class="col-sm-4 col-xl-2 offset-xl-0 align-self-center mt-1"><input class="form-control form-control-sm search form-control" type="text" placeholder="Search by typing here.." style="font-size: 12px;"></div>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
