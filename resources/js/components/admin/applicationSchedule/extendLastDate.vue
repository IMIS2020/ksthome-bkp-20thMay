                                    ...
                                    <div>
                                        <form>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-xl-4"><label>Scholarship Type</label>
                                                            <div class="form-group"><select class="form-control form-control-sm" disabled="" readonly="">
                                                                    ...
                                                                    <option value="1" selected="">Nursing Scholarship</option>
                                                        ...
                                                        <div class="col-xl-4"><label>Previous Last Date</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="date" disabled="" readonly=""></div>
                                                        </div>
                                                        <div class="col-xl-4"><label>Updated Last Date</label>
                                            ...
                                            <div class="com-bg pt-2 mt-2">
                                                <div class="form-row">
                                                    <div class="col-xl-3 offset-xl-3 pr-1"><a class="btn btn-block btn-sm btn-custom btn-smd" role="button" href="#"><strong><em>Save</em></strong></a></div>
                                                    <div class="col-xl-3 offset-xl-0 pr-1"><router-link class="btn btn-block btn-sm btn-cancel btn-smd" role="button" to="/admin/manage-application-schedule"><strong><em>Cancel</em></strong></router-link></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
