                        ...
                        <div class="col-md-12 col-xl-12 offset-xl-0 px-0">
                            <div class="row my-2">
                                <div class="col-xl-12 offset-xl-0">
                                    <h4 class="mb-0 p-head">Manage Applications</h4>
                                </div>
                            </div>
                            <div class="com-bg">
                                <div>
                                                ...
                                                <form>
                                                    <div class="form-group mb-0">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-sm-4 col-xl-3 offset-xl-0 text-right align-self-center mt-1 px-0"><input class="form-control form-control-sm search form-control" type="text" placeholder="Search by typing here.." style="font-size: 12px;"></div>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <table class="table table-sm">
                                            <thead class="cs-tbl-hd">
                                                <tr>
                                                    ...
                                                    <th class="text-center w-10x">Submitted On</th>
                                            ...
                                            <tbody style="color:#000;"  class="h-41x font-sm ">
                                                <tr v-for="(eachUser,i) in allUsers" :key="i">
                                                    ...
                                                    <td>{{eachUser[1].applicantNameF}} {{(eachUser[1].applicantNameM)?" "+eachUser[1].applicantNameM:''}} {{eachUser[1].applicantNameL}},<br>Gender: {{eachUser[1].applicantGender}},<br>DOB : {{(eachUser[1].applicantDOB).split('-').reverse().join('/')}} <br> Age: <span v-if="calAge(eachUser[1].applicantDOB) !== null">( {{ calAge(eachUser[1].applicantDOB).years }} Years {{ calAge(eachUser[1].applicantDOB).months }} Months &amp; {{ calAge(eachUser[1].applicantDOB).days}} Days )</span></td>
 ...
 calAge: function (dob) {
      ...
      let monthAge =
        currentMonth >= dobMonth
          ? currentMonth - dobMonth
          : (yearAge--, 12 + currentMonth - dobMonth);
      let dateAge =
        currentDate >= dobDate
          ? currentDate - dobDate
          : (monthAge--,
            31 + currentDate - dobDate,
            monthAge < 0 ? ((monthAge = 11), yearAge--) : "");
    ...
    usersDetails()
    {
       axios.get('/admin/admin-api/manage-application-details/get-data')
            .then(response =>{
