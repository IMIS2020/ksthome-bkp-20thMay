                                                    ...
                                                    <table class="table table-bordered table-sm mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><a class="act-link"><i class="fa fa-download"></i></a></td>
                                                                <td class="text-center">
                                                                    <router-link class="act-link" to="/print-view-HHDLSS" data-target="#vw-apo-form"><i class="fa fa-eye"></i></router-link>
                                                                 </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
