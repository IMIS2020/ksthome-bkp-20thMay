                                ...
                                <div class="col-xl-12">
                                    <div>
                                       <!-- <ul role="tablist" class="nav nav-tabs font-sm">
                                          ...
                                          <li class="nav-item" role="presentation"><router-link class="nav-link active" role="tab" data-toggle="tab" :to="'/admin/review-HHDLSS-annexure-2/'+getdata.applicationId"><strong>Annexure-II</strong></router-link></li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active adm-tab" role="tabpanel" id="tab-3">
