                        ...
                        <div class="col-md-12 col-xl-12 offset-xl-0 px-0">
                            <div class="row my-2">
                                <div class="col-xl-12 offset-xl-0">
                                    <h3 class="text-break text-uppercase p-head mb-0">financial year : {{new Date().getFullYear() }}-{{(new Date().getFullYear()+1).toString().substr(-2)}}</h3>
                                </div>
                            </div>
                            <div class="com-bg pt-4">
                                <div class="row">
                                    ...
                                    <div v-if="userId =='SU-000001'" class="col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-md-0 offset-lg-0 offset-xl-0 mb-3 px-1">
                                    ...
                                    <router-link to="/admin/manage-application-details">
                                     ...
                                     <div v-if="userId =='SU-000001'" class="col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-0 mb-3 pl-1">
                                        <router-link to="/admin/manage-internal-users">
                                            <div class="home-icon">
                                                <h3 class="text-break text-uppercase"><strong>manage </strong><br><strong>Users</strong><br></h3>
                                            </div>
                                        </router-link>
                                    </div>
                                    ...
                                    <router-link to="/admin/all-registered-users">
                                            <div class="home-icon">
                                                <h3 class="text-break text-uppercase"><strong>view</strong><br><strong>Applicants</strong><br></h3>
                                            </div>
                                     </router-link>
                                    </div>
                                </div>
