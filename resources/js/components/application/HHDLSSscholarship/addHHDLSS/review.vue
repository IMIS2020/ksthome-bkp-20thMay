                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-xl-12 mb-2">
                                                    <div class="card mt-2 det-sec">
                                                        ...
                                                        <div class="card-body">
                                                            <p class="t-c-text">I {{getdata.fullName}} hereby declare that to the best of my knowledge the above information furnished by me is true and I understand that if at any stage, it is found that the information provided by me is false/ not true, all the benefits given to me under “HHDLSS Scholarship” could be withdrawn.</p>
                                                            <div class="form-group mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" id="formCheck-1" v-model='terms'>
                                                                    <label class="form-check-label" for="formCheck-1">I accept the terms &amp; conditions</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <button class="btn btn-sm btn-mg" type="button" :disabled='isDisabled'>Submit Application Form</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
