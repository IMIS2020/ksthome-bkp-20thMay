                        ...
                        <div class="col-md-12 col-xl-12 offset-xl-0 px-0">
                            <div class="row mt-2">
                                <div class="col-xl-12 offset-xl-0 mb-2">
                                    <h4 class="mb-0 p-head">Extend Last Application Date</h4>
                                </div>
                                <div class="col-xl-8 offset-xl-2">
                                    <div>
                                        <form @submit.prevent="updateLastDate">
                                            <div class="com-bg">
                                                <div class="form-row">
                                                    <div class="col-xl-12 offset-xl-0">
                                                        <p class="text-center my-2 color-mg"><strong>Update Last Date </strong></p>
                                                    </div>
                                                </div>
                                                <div style="background-color: #fff;padding: 10px;border-radius: 5px;">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-xl-4"><label>Start Date</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" v-model="formGet.startDate" type="date" readonly=""></div>
                                                        </div>
                                                        <div class="col-xl-4"><label>Current Last Date</label>
                                                            <div class="form-group"><input class="form-control form-control-sm" type="date"  v-model="formGet.lastDate" readonly=""></div>
                                                        </div>
                                                        <div class="col-xl-4">
                                                            <label>New Last Date</label>
                                                            <div class="form-group">
                                                                <input class="form-control form-control-sm"  v-model="formUpdate.newLastDate" type="date" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
export default {
    ...
    methods:{
        getData(){
            axios.get('/admin/admin-api/get-extend-last-date-nursing/'+this.scholarshipTypeValueId)
            .then(response => {
         ...
         updateLastDate()
            {
                axios.post('/admin/admin-api/edit-last-date-nursing/'+this.scholarshipTypeValueId,this.formUpdate)
                .then(() =>{this.$fire({
                  position:'top',
                  icon: 'success',
