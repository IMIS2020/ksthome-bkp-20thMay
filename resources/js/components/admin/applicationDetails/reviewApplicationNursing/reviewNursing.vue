        ...
        <div class="container">
            <form>
                <div class="form-row">
                    ...
                    <div class="col-xl-2 offset-xl-0 my-2"><router-link class="btn btn-danger btn-block btn-sm d-none" type="button" to="/manage-scholarship"><strong>Cancel</strong></router-link></div>
                </div>
            </form>
        </div>
 <!-- Modal - 1 -->
