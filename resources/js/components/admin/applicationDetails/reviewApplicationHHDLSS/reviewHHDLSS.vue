                                    ...
                                    <div>
                                       <ul role="tablist" class="nav nav-tabs font-sm">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active adm-tab" id="tab-5">
                                                    <form>
                                                        <div class="div-inner-filed py-1">
                                                            <div class="form-row">
                                                                    ...
                                                                    <div class="table-responsive table-bordered font-sm rev-tbl">
                                                                        <table class="table table-bordered table-sm mb-0">
                                                                            <thead class="color-mg">
                                                                                <tr>
                                                                                    <th class="w-38x">Document Name</th>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.admissionLetterStatus">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.photographStatus"> 
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.proofOfAgeStatus">
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.markSheets10Status">
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.markSheets12Status">
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                                ...
                                                                                <tr v-if="getdata.applicantLeprosyAffectedMother == true">
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.leprosyCertificateSelfStatus">
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                                ...
                                                                                <tr v-if="getdata.applicantLeprosyAffectedFather == true">
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="form-group mb-0">
                                                                                            <select class="form-control form-control-sm font-s" v-model="form.leprosyCertificateMotherStatus">
                                                                                                <option value selected>-- select --</option>
                                                                                                <option value="OK">OK</option>
                                                                                                <option value="Not OK">Not OK</option>
                                                                                                <option value="Not Required">Not Required</option>
                                                                ...
                                                                <div class="col-xl-12 offset-xl-0">
                                                                    <div role="dialog" tabindex="-1" class="modal fade" id="accept-application-view" style="z-index: 1051;">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body cs-modal-body">
                                                                                    <div class="form-row">
                                                                                        ...
                                                                                        <div class="col-xl-11 mb-2">
                                                                                            <div class="form-group mb-0"><input type="email" class="form-control form-control-sm" placeholder="Email goes here." /></div>
                                                                                        </div>
                                                                    ...
                                                                    <div role="dialog" tabindex="-1" class="modal fade" id="return-application-view" style="z-index: 1051;">
                                                                        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header py-1">
    ...
    methods:{
     ...
     getdataHHDLSS()    
      {    
        ...
        getFileData(){
          const  currentUrl = window.location.pathname.split('/').reverse()[0];
            axios.get('/admin/admin-api/review-HHDLSS-review-submit/'+currentUrl)
            .then(response => {
                if (response.data['success']) {
