                                ...
                                <div class="form-row svc-row">
                                    <div class="col-xl-12">
                                        <p class="color-mg font-md">If you do not have an account,
                                            ...
                                            <a href="/">sign in</a> here. Type your email address in the field below to receive your validation code.</p>
                                    </div>
                                    ...
                                    <div class="col-xl-5 mt-2">
                                        <div class="form-group">
                                            <button class="btn btn-sm btn-mg " type="submit">Send verification code</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
